...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (subcommand === "report") {
      ...
      if (threshold !== null) {
        newSettings.risk_threshold = threshold;
      }
      if (critical !== null) {
        newSettings.severity_critical = critical;
      }
      if (high !== null) {
        newSettings.severity_high = high;
      }
      if (medium !== null) {
        newSettings.severity_medium = medium;
      }
      if (low !== null) {
        newSettings.severity_low = low;
      }
      if (recentMultiplier !== null) {
        newSettings.recent_multiplier = recentMultiplier;
      }
      if (recentDays !== null) {
        newSettings.recent_days = recentDays;
      }
