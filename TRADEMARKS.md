...
- ❌ Using similar logos or color schemes
- ❌ Copying our website design
- ❌ Using our tagline or slogans
- ❌ Replicating our documentation branding
...
We may grant permission for trademark use in special cases:

### Official Partners

- Approved contributors to the main project
- Official integrations and extensions
- Verified community projects

### How to Request Permission

Open an issue on GitHub or contact us through our support server explaining:

1. What you want to use
2. How you'll use it
3. Why you need permission
...
- Request changes to confusing names
- Report trademark violations
- Take legal action for serious violations

### Good Faith

We understand mistakes happen. If you're unsure:

1. Ask before using
2. Be transparent about your fork
3. Give proper attribution

### Updates

This policy may be updated. Check the "Last Updated" date above.
...
- **Support Server**: [Join our Discord](https://discord.gg/warmA4BsPP)
...
- ✅ Use the **code** freely (MIT License)
- ❌ Don't use the **name/branding** without permission
- 📝 Give proper attribution
- 🎯 Choose a unique name for your fork
- 🤝 When in doubt, ask!

---

**Thank you for respecting our trademarks while using our open-source code!** 🙏

---

## Related Documents

- [MIT License](LICENSE) - Code usage rights
