  ...
  async restoreBackup(guild, backupId, options = {}) {
    ...
    try {
      ...
      const ALLOWED_BACKUP_MIGRATIONS = {
        "1444737803660558396_1764534899859": "1450529013302038639", // Old Sentinel guild -> New Sentinel guild (Nov 30)
        "1444737803660558396_1765727521924": "1450529013302038639", // Old Sentinel guild -> New Sentinel guild (Dec 14 - Full roles/channels)
      };
