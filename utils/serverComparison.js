...
class ServerComparison {
  ...
  getBadge(score) {
    if (score >= 90) {
      return { name: "Fortress", emoji: "🏰", color: "#FFD700" };
    }
    if (score >= 75) {
      return { name: "Defender", emoji: "🛡️", color: "#C0C0C0" };
    }
    if (score >= 60) {
      return { name: "Guardian", emoji: "⚔️", color: "#CD7F32" };
    }
    if (score >= 40) {
      return { name: "Watchful", emoji: "👁️", color: "#4CAF50" };
    }
